          ...
          <div className="bg-white p-8 md:p-10 border-2 border-stone-200 mb-6">
            ...
            <div className="flex flex-wrap gap-3">
              <Button
                ...
                className="bg-stone-900 hover:bg-stone-800 text-white gap-2 border-2 border-stone-900"
              >
              ...
              {recipe.nutrition && (
                <div className="mt-6 pt-6 border-t-2 border-stone-200">
                  ...
                  <div className="grid grid-cols-2 gap-3">
                    <div className="bg-orange-500 p-3 text-center border-2 border-orange-600">
                      <div className="text-2xl font-bold text-white">
                        {recipe.nutrition.calories}
                      </div>
                      <div className="text-xs text-orange-50 font-bold uppercase tracking-wide">
                        Calories
                      </div>
                    </div>

                    <div className="bg-rose-500 p-3 text-center border-2 border-rose-600">
                      <div className="text-2xl font-bold text-white">
                        {recipe.nutrition.protein}
                      </div>
                      <div className="text-xs text-rose-50 font-bold uppercase tracking-wide">
                        Protein
                      </div>
                    </div>

                    <div className="bg-amber-500 p-3 text-center border-2 border-amber-600">
                      <div className="text-2xl font-bold text-white">
                        {recipe.nutrition.carbs}
                      </div>
                      <div className="text-xs text-amber-50 font-bold uppercase tracking-wide">
                        Carbs
                      </div>
                    </div>

                    <div className="bg-violet-500 p-3 text-center border-2 border-violet-600">
                      <div className="text-2xl font-bold text-white">
                        {recipe.nutrition.fat}
                      </div>
                      <div className="text-xs text-violet-50 font-bold uppercase tracking-wide">
                        Fat
                      </div>
                    </div>
                  </div>
